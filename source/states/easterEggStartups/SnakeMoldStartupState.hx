...
class SnakeMoldStartupState extends SuffState {
	...
	function startIntro() {
		ambientSound = new FlxSound().loadEmbedded(Paths.sound('ui/startup/snakemold/fanAmbience'));
		...
		luna.frames = Paths.sparrowAtlas('ui/menus/easterEggStartups/snakemold/luna');
	...
	function skipIntro() {
		...
		SuffState.playUISound(Paths.sound('ui/startup/snakemold/limeTestLinux'), 2);
